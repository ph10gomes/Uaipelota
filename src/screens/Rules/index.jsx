        ...
        <ImageBackground
            ...
            <View style={styles.content}>
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', padding: 50, alignItems: 'center', justifyContent: 'center' }}>
                    <TouchableOpacity style={[styles.card, players === 10 && styles.active]} onPress={() => setPlayers(10)}>
                        <Text style={styles.txtCard}>10</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={[styles.card, players === 15 && styles.active]} onPress={() => setPlayers(15)}>
                        <Text style={styles.txtCard}>15</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={[styles.card, players === 20 && styles.active]} onPress={() => setPlayers(20)}>
                        <Text style={styles.txtCard}>20</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={[styles.card, players === 25 && styles.active]} onPress={() => setPlayers(25)}>
