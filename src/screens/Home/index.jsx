   ...
   return (
      <ImageBackground
         ...
         <View style={styles.cardArea}>
            ...
            <TouchableOpacity style={styles.card} onPress={() => navigation.navigate("SoccerList")}>
               <View style={{ flexDirection: "row", justifyContent: "space-between", width: "100%", padding: 10 }}>
                  <View style={styles.leftAside}>
                     <Text style={styles.cardTitle}>Lista</Text>
                     <Text style={styles.description}>Defina a lista dos jogadores que participarão da próxima pelada</Text>
                  </View>
                  <View style={{ width: 50, height: 50, backgroundColor: "#4BAE4F", borderRadius: 25, justifyContent: "center" }}>
                     <Image source={Lista} style={{ width: 30, height: 50, alignSelf: "center" }} resizeMode="contain" />
                  </View>
               </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.card} onPress={() => navigation.navigate("Rules")}>
               <View style={{ flexDirection: "row", justifyContent: "space-between", width: "100%", padding: 10 }}>
                  <View style={styles.leftAside}>
            ...
            <Button
               ...
               label="VOLTAR"
               style={{ width: "75%", marginTop: 20, alignSelf: "center", backgroundColor: "#800202" }}
            />
         </View>
      </ImageBackground>
   );
